...
Handles Spotify authentication and playlist creation using pipeline_steps functions
"""
...
def handle_spotify_auth():
    ...
    try:
        ...
        st.info("Check that credentials.txt exists and port 8888 is available.")
