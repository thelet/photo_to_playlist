...
NOTE: Most style settings are controlled by quick_modifications.py
"""
...
app_ui_v2_dir = Path(__file__).parent
if str(app_ui_v2_dir) not in sys.path:
    sys.path.insert(0, str(app_ui_v2_dir))

from config import THEME, LAYOUT
from quick_modifications import TEXT_SIZES, HEADER_SPACING, CUSTOM_CSS
